...
#include <algorithm>
#include <windows.h>
#include "C:\Dumper-7\4.16.0-3700114+++Fortnite+Release-Cert-FortniteGame\CppSDK\SDK.hpp"
...
static inline auto spoof_call(Ret(*fn)(Args...), Args... args) -> Ret
{
	...
	if (!jmprbx) {
		...
		const auto ntdll = reinterpret_cast<const unsigned char*>(InSDKUtils::GetImageBase());
